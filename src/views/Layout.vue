...
const handleMenuClick = (menuId) => {
    const routeMap = {
        ...
        'tab2-0': '/interface/interface-list',
        'tab2-2': '/interface/monitoring-panel',
        'tab2-3': '/interface/log-analysis',
...
onMounted(() => {
    ...
    const routeMap = {
        ...
        '/interface/interface-list': 'tab2',
        '/interface/monitoring-panel': 'tab2',
        '/interface/log-analysis': 'tab2',
